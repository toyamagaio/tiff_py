...
image   =tf.imread('20240205/#12_19.5MeV_11.5usecd_100nsecg_6minexp.tif')
bg_image=tf.imread('20240205/#13_background_6minexp.tif')
...
pp=PdfPages('ccd_19.5MeV_20240205.pdf')
